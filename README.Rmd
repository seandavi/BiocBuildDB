...
*The primary use for this package is to produce a set of relational tables that can be 
mined for better understanding the build system and our software ecosystems.* 
